...
*   **Tech:** Python (NLP with NLTK/Transformers, Pandas for time-series, SciPy for optimization).
*   **Methodology:** Scraping financial tweets -> Sentiment Scoring (VADER/BERT) -> Constructing a signal -> Backtesting vs. Benchmark (S&P 500).

#### 2. 🏦 Automated Pricing Tool (La Banque Postale)
> **Objective:** Reducing manual processing time for the pricing committee by automating data retrieval and report generation.
*   **Tech:** VBA (Macros), Excel.
*   **Result:** Developed macros to process NBI (Net Banking Income) data, generating decision-making summaries automatically.

#### 3. 📉 Exotic Options Pricing Engine (Academic Project)
